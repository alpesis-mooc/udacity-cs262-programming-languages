...
def nfsmsim(string, current, edges, accepting): 
    ...
    if not string:
        ...
        letter, remaining_string = string[0:1], string[1:]
        desitinations = edges.get((current,letter),[])
        return any(nfsmsim(remaining_string, desitination, edges, accepting) for desitination in desitinations)
